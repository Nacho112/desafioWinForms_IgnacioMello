    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonPrecioFinal_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool calPremium = radioButtonPremium.Checked;
                ...
                if (radioButtonCamisa.Checked)
                {
                    ...
                    Camisa miCamisa = new Camisa(mangaCorta, cant, precio, calStandard, calPremium);

                    precioU = miCamisa.CalcularPrecioFinal();
                ...
                if (radioButtonPantalon.Checked)
                {
                    ...
                    Pantalon miPantalon = new Pantalon(bermuda, cant, precio, calStandard, calPremium);

                    precioU = miPantalon.CalcularPrecioFinal();
                    int precioTotal = (int)(precioU * cant);
